...
namespace FindGT
{
    public static class Interop
    {
        ...
        [DllImport(
            "Secur32.dll",
            EntryPoint = "QueryCredentialsAttributesW",
        ...
        public static extern uint FreeContextBuffer(IntPtr pvContextBuffer);
        ...
        [DllImport("secur32.dll", SetLastError = true)]
        public static extern uint FreeCredentialsHandle(
            ref SECURITY_HANDLE phCredential
        );
